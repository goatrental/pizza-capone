...
export const Menu: React.FC = () => {
  ...
  const handleAddToOrder = (item: OrderItem) => {
    const existingItem = orderItems.find(orderItem => 
      ...
      JSON.stringify(orderItem.ingredients) === JSON.stringify(item.ingredients)
    );
  ...
  return (
    <>
      <section id="menu" className="py-20 bg-gradient-to-b from-amber-900/20 to-zinc-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-amber-200 italic">Každý pokrm má svůj příběh</p>
          </div>

          {/* Search Bar */}
          <div className="sticky top-20 bg-zinc-900/95 backdrop-blur-md border border-amber-800/30 rounded-2xl p-4 mb-8 z-30">
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="col-span-full flex flex-col items-center justify-center py-16">
                <div className="text-center">
                  <h3 className="text-2xl font-serif text-yellow-400 mb-4">Žádné výsledky</h3>
                  <p className="text-amber-200 mb-6">
                    Pro hledaný výraz "{searchTerm}" nebyly nalezeny žádné pokrmy.
                  </p>
                  <button
                    onClick={clearSearch}
